...
class Tools(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.img_records = load_image('record2.png', 'record1.png', size=(32, 32))
        self.img_pause = load_image('pause2.png', 'pause1.png')
        ...
        lb_kor = ctk.CTkLabel(master=self, image=im_korabl, text='', fg_color='transparent')
        lb_kor.grid(row=row, column=0, columnspan=2, pady=10, padx=2, sticky="we")
        row += 1
        self.btn_record = ctk.CTkButton(master=self,
                                        text="Запись", width=140, font=font,
                                        text_color=('gray10', 'gray90'),
                                        image=self.img_records,
                                        height=58, border_width=2,
        ...
        self.lab_time_gals = ctk.CTkLabel(master=self,
                                          ...
                                          anchor='w', width=70)
        self.lab_time_gals.grid(row=row, column=1, columnspan=2, padx=pdx_r, pady=(2, 2), sticky="e")
        row += 1
        ...
        self.btn_book.grid(row=row, column=0, columnspan=2, padx=pad_x, pady=(0, 5), sticky="ew")
        row += 1
        ttk.Separator(self).grid(
            pady=(10, 0), row=row, column=0, columnspan=2, padx=10, sticky="ew")
    ...
    def record(self) -> None:
        ...
        if self.btn_record.cget('text') == 'Запись' \
                and self.file_gals:                                             # and self.root.start_work
